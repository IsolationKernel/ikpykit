...
This package serves as a pyike package aiding at developing compatible
...
To create your package, you need to clone the ``pyike`` repository:

.. prompt:: bash $

  git clone https://github.com/IsolationKernel/pyike.git

Before to reinitialize your git repository, you need to make the following
changes. Replace all occurrences of ``pyike``, ``pyike``, or
``pyike`` with the name of you own project. You can find all the
