.. pyike documentation master file, created by
...
######################################################
pyike - Machine Learning Kits with Isolation Mechanism
######################################################

**Date**: |today| **Version**: |version|

**Useful links**:
`Source Repository <https://github.com/IsolationKernel/pyike>`__ |
`Issues & Ideas <https://github.com/IsolationKernel/pyikek/issues>`__ |

`pyike` refer to methods that employ an isolation mechanism to
