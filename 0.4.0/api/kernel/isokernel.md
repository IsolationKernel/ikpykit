...
| -------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- |
| `method`       | `str`                               | How the data space is partitioned to compute the isolation kernel feature. The three differ only in the shape of the cells they produce. - `anne`: Voronoi cells around sampled points (Qin et al., 2019). - `inne`: hyperspheres reaching each sampled point's nearest neighbour (Bandaragoda et al., 2018; Qin et al., 2019). - `iforest`: axis-parallel boxes cut by isolation trees (Ting et al., 2018). | `"anne"` |
